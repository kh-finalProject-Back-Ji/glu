...
public class EmailConfig {
	...
	// @Value : properties 에 작성된 내 중
	// key 가 일치하는 value 값을 얻어와 필드에 대입
	...
	public JavaMailSender javaMailSender() {
		...
		// 전송 프로토콜 설정을 위한 Properties 객체 생성
		...
		// SSL 프로토콜을 설정 여기서는 TLSv1.2 를 사용
		...
		// Bean으로 등록하여 Spring 애플리케이션에서 이메일을 보내기 위한 구성을 제공함
		return mailSender;
